...
namespace TaskInsightEngine.Infrastructure.Migrations
{
    ...
    [Migration("20260322105901_TaskAssignment")]
            ...
            modelBuilder.Entity("TaskInsightEngine.Domain.Entities.TaskAssignment", b =>
                {
                    ...
                    b.HasOne("TaskInsightEngine.Domain.Entities.TaskItem", "Task")
                        .WithOne("TaskAssignment")
                        .HasForeignKey("TaskInsightEngine.Domain.Entities.TaskAssignment", "TaskAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
