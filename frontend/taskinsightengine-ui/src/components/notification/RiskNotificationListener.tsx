    ...
    useEffect(() => {
        ...
        const startConnection = async () => {
            try {
                ...
                connection.on("ReceiveDailyBriefing", (snapshot: BriefingSnapshot, projectName: string, projectId: number) => {
                    ...
                    toast.warning("Daily Briefing Update", {
                        ...
                        action: {
                            label: "View Briefing",
                            onClick: () => (window.location.href = `/dashboard/showprojectmetrics/${projectId}`),
                        },
                    });
                });
            }
